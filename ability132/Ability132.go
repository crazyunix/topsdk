...
import (
	...
	"github.com/crazyunix/topsdk/ability132/request"
	"github.com/crazyunix/topsdk/ability132/response"
...
批量发送消息
*/
func (ability *Ability132) TaobaoTmcMessagesProduce(req *request.TaobaoTmcMessagesProduceRequest, session string) (*response.TaobaoTmcMessagesProduceResponse, error) {
	if ability.Client == nil {
		return nil, errors.New("Ability132 topClient is nil")
	}
	var jsonStr, err = ability.Client.ExecuteWithSession("taobao.tmc.messages.produce", req.ToMap(), req.ToFileMap(), session)
