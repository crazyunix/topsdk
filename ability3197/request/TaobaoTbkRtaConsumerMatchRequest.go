...
import (
	"github.com/crazyunix/topsdk/ability3197/domain"
...
type TaobaoTbkRtaConsumerMatchRequest struct {
	...
	/*
	   活动列表     */
	OfferList *[]domain.TaobaoTbkRtaConsumerMatchOfferList `json:"offer_list,omitempty" required:"false" `
	/*
...
func (s *TaobaoTbkRtaConsumerMatchRequest) SetStrategyIdList(v []string) *TaobaoTbkRtaConsumerMatchRequest {
	s.StrategyIdList = &v
	return s
}
...
func (req *TaobaoTbkRtaConsumerMatchRequest) ToMap() map[string]interface{} {
	...
	if req.StrategyIdList != nil {
		paramMap["strategy_id_list"] = util.ConvertBasicList(*req.StrategyIdList)
	}
	return paramMap
}
