...
type TaobaoTbkDgGeneralLinkConvertItemUrlList struct {
	...
	/*
	   营销信息     */
	PromotionInfoDto *TaobaoTbkDgGeneralLinkConvertItemPromotionInfoDTO `json:"promotion_info_dto,omitempty" `
	...
	/*
	   多件价券信息     */
	MultipleItemsCouponInfoList *[]TaobaoTbkDgGeneralLinkConvertItemMultiCouponPromotionInfoDTO `json:"multiple_items_coupon_info_list,omitempty" `
}
...
func (s *TaobaoTbkDgGeneralLinkConvertItemUrlList) SetPromotionInfoDto(v TaobaoTbkDgGeneralLinkConvertItemPromotionInfoDTO) *TaobaoTbkDgGeneralLinkConvertItemUrlList {
...
func (s *TaobaoTbkDgGeneralLinkConvertItemUrlList) SetMultipleItemsCouponInfoList(v []TaobaoTbkDgGeneralLinkConvertItemMultiCouponPromotionInfoDTO) *TaobaoTbkDgGeneralLinkConvertItemUrlList {
