...
type TaobaoTbkDgGeneralLinkConvertLkItemDTO struct {
	...
	/*
	   商品库账号ID     */
	ManagePubId *int64 `json:"manage_pub_id,omitempty" `
}
...
func (s *TaobaoTbkDgGeneralLinkConvertLkItemDTO) SetManagePubId(v int64) *TaobaoTbkDgGeneralLinkConvertLkItemDTO {
	s.ManagePubId = &v
	return s
}
