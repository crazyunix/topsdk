...
type TaobaoTbkDgGeneralLinkConvertMaterialUrlList struct {
	...
	/*
	   营销信息     */
	PromotionInfoDto *TaobaoTbkDgGeneralLinkConvertMaterialPromotionInfoDTO `json:"promotion_info_dto,omitempty" `
	...
	/*
	   多件价券信息     */
	MultipleItemsCouponInfoList *[]TaobaoTbkDgGeneralLinkConvertMaterialMultiCouponPromotionInfoDTO `json:"multiple_items_coupon_info_list,omitempty" `
}
...
func (s *TaobaoTbkDgGeneralLinkConvertMaterialUrlList) SetPromotionInfoDto(v TaobaoTbkDgGeneralLinkConvertMaterialPromotionInfoDTO) *TaobaoTbkDgGeneralLinkConvertMaterialUrlList {
...
func (s *TaobaoTbkDgGeneralLinkConvertMaterialUrlList) SetMultipleItemsCouponInfoList(v []TaobaoTbkDgGeneralLinkConvertMaterialMultiCouponPromotionInfoDTO) *TaobaoTbkDgGeneralLinkConvertMaterialUrlList {
	s.MultipleItemsCouponInfoList = &v
	return s
}
